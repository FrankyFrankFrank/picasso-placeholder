...
>
    <defs>
        <linearGradient id="linear_gradient_01" gradientTransform="rotate(90)">
            <stop offset="5%"  stop-color="hsl(305, 30%, 70%)" />
            <stop offset="95%" stop-color="hsl(275, 30%, 50%)" />
        </linearGradient>

        <filter id="shadow">
          <feDropShadow dx="1" dy="1" stdDeviation="2" flood-color="hsla(305, 30%, 20%, 0.3)" />
        </filter>
    </defs>
